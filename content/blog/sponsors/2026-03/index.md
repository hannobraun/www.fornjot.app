...
- Why I still write my code by hand, instead of using an LLM.
- Sounds like not a lot, in this summary, but was actually very difficult to fit.
...
These days, my sponsorship income hovers around, or slightly below, the point where it can cover my costs. This works for now, but with no surplus, it is not truly sustainable. **Every new sponsor makes a big difference!**
